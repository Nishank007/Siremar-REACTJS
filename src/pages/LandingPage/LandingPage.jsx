                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="dbox w-100 text-center">
                                                    ...
                                                    <div class="text">
                                                        <p><span>Address:</span> <span class="address-text">198 West 21th Street, Suite 721 Margarita NY 10016</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="dbox w-100 text-center">
                                                    ...
                                                    <div class="text">
                                                        <p><span>Phone:</span> <a href="tel://1234567920">+ 1234567897</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="dbox w-100 text-center">
                                                    ...
                                                    <div class="text">
                                                        <p><span>Email:</span> <a href="mailto:siremar@gmail.com">siremar@gmail.com</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="contact-wrap">
                                            <form method="POST" id="contactForm" name="contactForm" class="contactForm">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" value="Send Message" class="btn primary-default-button" >Submit</button>
