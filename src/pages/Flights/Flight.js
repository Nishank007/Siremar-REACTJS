                        ...
                        <form class="register-form" action="" method="">
                            <div class="flex-row">
                                <label class="custom-form-label-wrapper">
                                    ...
                                    <input  type="text" placeholder="Enter the airlines name" required />
                                </label>
                                <label class="custom-form-label-wrapper">
                                    <p class="custom-form-label">Flight number</p>
                                    <input  type="number" placeholder="Enter the flight no" required />
                                </label>
                                ...
                                <label class="custom-form-label-wrapper">
                                    ...
                                    <input  type="text" placeholder="Enter the destination" required />
                                </label>
                                <label class="custom-form-label-wrapper">
