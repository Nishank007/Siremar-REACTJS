                                ...
                                <form class="register-form" action="" method="">
                                    <div class="flex-row">
                                        <label class="custom-form-label-wrapper">
                                            ...
                                            <input  type="text" placeholder="Enter the inspector name" required />
                                        </label>
                                        ...
                                        <label class="custom-form-label-wrapper">
                                            <p class="custom-form-label">County Assigned</p>
                                            <input  type="text" placeholder="Enter county assigned for inspector" required />
                                        </label>
                                    </div>
